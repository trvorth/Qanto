...
pub fn mul_scale(a: i128, b: i128) -> i128 {
    a.checked_mul(b).map(|res| res / SCORE_SCALE).unwrap_or(0)
}
...
pub fn mul_scale_u128(a: u128, b: u128) -> u128 {
    a.checked_mul(b).map(|res| res / QANTO_SCALE).unwrap_or(0)
}
...
pub fn div_scale(a: i128, b: i128) -> i128 {
    ...
    a.checked_mul(SCORE_SCALE).map(|res| res / b).unwrap_or(0)
}
...
pub fn div_scale_u128(a: u128, b: u128) -> u128 {
    ...
    a.checked_mul(QANTO_SCALE).map(|res| res / b).unwrap_or(0)
}
