...
mod tests {
    ...
    #[test]
    fn test_password_mismatch_logic() {
        // We can't easily test interactive input, but we can verify our trimming logic
        // and error messages if we were to refactor it to accept readers.
        // For now, we'll verify the trimming logic explicitly.
        let p1 = "  password123  \n";
        let p2 = "  password123  ";
        assert_eq!(p1.trim(), p2.trim());
    }
}
