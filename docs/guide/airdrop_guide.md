# QANTO Layer-0 Mainnet Alpha: ZK-Airdrop Onboarding Guide 🌐
...
5. Enter the following network parameters to connect to the QANTO Mainnet Alpha mesh:

| Parameter | Value |
| :--- | :--- |
| **Network Name** | QANTO Mainnet Alpha |
...
6. Click **Save** and switch your network to **QANTO Mainnet Alpha**.
