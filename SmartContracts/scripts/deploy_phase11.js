...
async function main() {
    ...
    // Mock Merkle Root for testing (calculated for 0x...0001 receiving 1000 QNTO)
    ...
    const wqntoMockAddress = "0x9F00000000000000000000000000000000000001";

    // 3. Deploy Airdrop Contract
    const Airdrop = await hre.ethers.getContractFactory("QantoDrop");
    const airdrop = await Airdrop.deploy(wqntoMockAddress, mockMerkleRoot);
