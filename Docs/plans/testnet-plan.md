...
Participants in the "Gladius" phase will be eligible for rewards from a dedicated public testnet token allocation. The reward structure will be based on a point system allocated for:
