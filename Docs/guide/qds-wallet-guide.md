...
```
/ip4/127.0.0.1/tcp/30303/ws/p2p/12D3KooWEu5pQv3oJc3j9bBmQYF5uWfZrKQhQAbCdEfGhIjKlMn
```
...
```
📊 Balance for ae527b...f9d3: 123.456789000 QANTO (123456789000 base units)
```
...
```toml
p2p_address = "/ip4/127.0.0.1/tcp/30303/ws"
