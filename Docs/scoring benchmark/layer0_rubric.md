...
- 2: Prototype throughput; known bottlenecks; inefficient I/O/storage. Evidence: unresolved future-enhancement notes without roadmap.
...
- 4: Emulators/simulators; scaffolding; CI-ready templates; devnet→testnet workflows; migration guides; observability hooks. Evidence: demo apps, error catalog.
...
- No external audit on consensus/bridge core before public testnet scale-out.
